 ...
 */
class DisplayElem : public nonCopyable 
{
    protected:    
        DisplayElem() 
        {
 ...
 */
class Displayer : public std::unary_function<void, const DisplayElem*>
{
private:
    std::ostream& m_os;
    char   m_sep;
 ...
 */
class Letter : public DisplayElem, public CreatableParam<Letter, char> 
{
    private:
        char m_ch;
 ...
 */
class Word : public DisplayElem, public Creatable<Word> 
{
    private:
 ...
 */
class Sentence : public DisplayElem, public CreatableParam<Sentence, ESentenceType> 
{
    private:
    ...
    public:
        Sentence() : m_sentenceType(eStatement) 
        {
 ...
 */
class Message : public DisplayElem, public Creatable<Message> 
{
    private:
